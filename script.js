...
const currentMoviesWithTheaters = {
    'リロ＆スティッチ': ['T・ジョイ博多', 'ユナイテッド・シネマ キャナルシティ', 'TOHOシネマズ天神・ソラリア館'],
    '国宝': ['T・ジョイ博多', 'ユナイテッド・シネマ キャナルシティ', 'KBCシネマ'],
    'フロントライン': ['T・ジョイ博多', 'ユナイテッド・シネマ ふくおかももち'],
    'ミッション：インポッシブル ファイナル・レコニング': ['ユナイテッド・シネマ キャナルシティ', 'TOHOシネマズららぽーと福岡'],
    'ドールハウス': ['kino cinema天神', 'KBCシネマ'],
    'かくかくしかじか': ['T・ジョイ博多', 'kino cinema天神'],
    '名探偵コナン 隻眼の残像': ['T・ジョイ博多', 'ユナイテッド・シネマ キャナルシティ', 'TOHOシネマズ天神・ソラリア館']
};
